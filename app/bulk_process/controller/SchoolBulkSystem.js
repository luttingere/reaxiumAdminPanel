/**
 * Created by VladimirIlich on 22/5/2016.
 */
angular.module("App")
    .controller("BulkSchoolCtrl",function($scope,
                                          $sessionStorage,
                                          $state,
                                          growl,
                                          spinnerService,
        ...
        $scope.processBulkSchool = function(){
            ...
            if(!isEmptyString(nameFile)){
                ...
                BulkService.sendBulkSchool(sendObj)
                    .then(function(resp){

                        spinnerService.hide('spinnerNew');

                        if(resp.ReaxiumResponse.code == GLOBAL_CONSTANT.SUCCESS_RESPONSE_SERVICE){
                            BusinessService.setShowGrowlMessage({isShow:true,message:"User load completed successfully"});
